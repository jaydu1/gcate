...
for ic, cell_type in enumerate(cell_types[4:]):
    ...
    df_res.to_csv(path_result+'gcate_full_{}.csv'.format(cell_type), index=False)
    ...
    if cell_type == 'T4':
        ...
        for r in range(1,11):
            ...
            with open('result/lupus/dill_{}_gcate_full_r_{}.pkl'.format(cell_type, r), "wb") as file_object:
                dill.dump([
